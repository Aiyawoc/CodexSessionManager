...
_TEXT: dict[GuiLanguage, dict[str, str]] = {
    GuiLanguage.ZH_CN: {
        ...
        "cleanup_candidate_count": "LLM 建议 {count} 个；可补选 {supplemental} 个；{missing} 个建议目标当前不可见",
        ...
        "load_id": "加载 ID",
        "task_filter": "筛选",
        "task_filter_accessible": "筛选 Codex 项目和任务",
        "task_filter_older": "天数 > N 天",
        "task_filter_all": "全部",
        "task_filter_active": "活跃",
        "task_filter_archived": "已归档",
        "task_select_all_accessible": "全选当前筛选的任务",
        "task_filter_older_title": "按天数筛选",
        "task_filter_older_prompt": "显示更新时间超过多少天的任务：",
        "task_filter_older_value": "天数 > {days} 天",
        "not_loaded": "尚未加载任务",
        "loaded_context": "{title} · {status} · {turns} turns",
        "context_read_only_review": "只读浏览：来源映射不完整，不能生成或应用上下文方案",
        "context_apply_unavailable": "当前仅支持审查与投影计划，不能应用上下文方案。",
        "task_capabilities_unavailable": "任务能力尚未加载，归档操作已禁用。",
        ...
        "unarchive_selected": "反归档所选对话（{count}）…",
        "clipboard_unavailable": "系统剪贴板当前不可用。",
        "id_copied": "已复制对话 ID。",
        "task_stale": "所选对话已不在当前列表中，请刷新后重试。",
        "select_task": "请先选择至少一个对话。",
        "archive_mixed_or_unsafe": "所选内容包含活跃与已归档任务，或当前状态不满足安全门禁；请分别选择后重试。",
        ...
        "unarchive_plan_busy": "正在展开派生后代并生成反归档计划…",
        "unarchive_confirm_title": "确认反归档计划",
        "unarchive_confirm": "计划 ID：{plan_id}\n根对话：{roots}；包含派生后代共 {affected} 个对话。\n\n应用时会再次复核状态、后代闭包和协议能力。是否应用？",
        "unarchive_saved": "反归档计划已保存但未执行：{plan_id}",
        "unarchive_apply_busy": "正在复核并应用反归档计划…",
        "unarchive_done_title": "反归档完成",
        "unarchive_done": "已反归档 {count} 个根对话。\n计划 ID：{plan_id}",
    ...
    GuiLanguage.EN_US: {
        ...
        "cleanup_candidate_count": "{count} LLM suggestions; {supplemental} safe additions; {missing} suggested targets unavailable",
        ...
        "load_id": "Load ID",
        "task_filter": "Filter",
        "task_filter_accessible": "Filter Codex projects and tasks",
        "task_filter_older": "Days > N",
        "task_filter_all": "All",
        "task_filter_active": "Active",
        "task_filter_archived": "Archived",
        "task_select_all_accessible": "Select all tasks in the current filter",
        "task_filter_older_title": "Filter by age",
        "task_filter_older_prompt": "Show tasks not updated for more than this many days:",
        "task_filter_older_value": "Days > {days}",
        ...
        "context_apply_unavailable": "Only review and projection plans are supported; context application is unavailable.",
        "task_capabilities_unavailable": "Task capabilities are not loaded; archive actions are disabled.",
        ...
        "unarchive_selected": "Unarchive selected ({count})…",
        ...
        "archive_mixed_or_unsafe": "The selection mixes active and archived tasks, or fails a safety gate. Select each state separately and retry.",
        ...
        "unarchive_plan_busy": "Expanding derived descendants and preparing an unarchive plan…",
        "unarchive_confirm_title": "Confirm unarchive plan",
        "unarchive_confirm": "Plan ID: {plan_id}\nRoot conversations: {roots}; {affected} conversations including derived descendants.\n\nApplication rechecks state, descendant closure, and protocol capabilities. Apply it?",
        "unarchive_saved": "Unarchive plan saved but not applied: {plan_id}",
        "unarchive_apply_busy": "Rechecking and applying the unarchive plan…",
        "unarchive_done_title": "Unarchive complete",
        "unarchive_done": "Unarchived {count} root conversations.\nPlan ID: {plan_id}",
