...
_TEXT: dict[GuiLanguage, dict[str, str]] = {
    GuiLanguage.ZH_CN: {
        ...
        "load_id": "加载 ID",
        "older_than_days_label": "更新时间",
        "older_than_days_prefix": "超过 ",
        "older_than_days_suffix": " 天",
        "older_than_days_all": "全部",
    ...
    GuiLanguage.EN_US: {
        ...
        "load_id": "Load ID",
        "older_than_days_label": "Updated",
        "older_than_days_prefix": "Older than ",
        "older_than_days_suffix": " days",
        "older_than_days_all": "All",
