...
_TEXT: dict[GuiLanguage, dict[str, str]] = {
    GuiLanguage.ZH_CN: {
        ...
        "purge_blocked_upstream": "永久删除执行已因上游 App Server 版本与状态迁移不兼容而关闭；计划与审查仍可用。",
        ...
        "purge_confirm": "计划 ID：{plan_id}\n根对话 {roots} 个，包含派生后代共 {affected} 个对话。\n\n请输入：确认删除",
        "purge_saved": "删除计划已保存但未执行：{plan_id}",
        "purge_mismatch": "永久删除确认短语不匹配；计划未执行。",
    ...
    GuiLanguage.EN_US: {
        ...
        "purge_blocked_upstream": "Permanent deletion application is closed because the App Server version is incompatible with the migrated state store; planning and review remain available.",
        ...
        "purge_confirm": "Plan ID: {plan_id}\n{roots} root conversations; {affected} conversations including derived descendants.\n\nEnter: 确认删除",
        "purge_saved": "Deletion plan saved but not applied: {plan_id}",
        "purge_mismatch": "The permanent-deletion phrase did not match; nothing was deleted.",
