...
_TEXT: dict[GuiLanguage, dict[str, str]] = {
    GuiLanguage.ZH_CN: {
        ...
        "cleanup_purge_group_tooltip": "仅展示已归档至少 14 天、具有可信归档记录和当前有效备份的根对话。这里不会生成或执行永久删除计划。",
    ...
    GuiLanguage.EN_US: {
        ...
        "cleanup_purge_group_tooltip": "Shows only roots archived for at least 14 days with trusted archive history and a current verified backup. No permanent-deletion plan is created or applied here.",
